        ...
        if (battles.length > 0) {
            if (numLeftShips == 0 || numRightShips == 0) {
                if (project121.flag == 1) {
                    document.getElementById("victoryDiv").style.visibility =
                        "visible";
                    ...
                    if (numLeftShips == 0) {
                        ...
                        document.getElementById("battleResultSign").innerHTML =
                            "-";
                        document.getElementById("honorAmount").innerHTML =
                            battleLEFTSHIPS;
                    ...
                    if (diceRoll > battleDEATH_THRESHOLD) {
                        ...
                        if (p.team == 0) {
                            ...
                            document.getElementById(
                                "probesLostCombatDisplay",
                            ).innerHTML = numberCruncher(probesLostCombat);
                        } else {
                            numRightShips--;
                            ...
                            document.getElementById(
                                "driftersKilled",
                            ).innerHTML = numberCruncher(driftersKilled);
