...
var project17 = {
    ...
    effect: function () {
        ...
        trust = trust + 1;
        displayMessage(
            "The T\xF3th Sausage Conjecture: proven, TRUST INCREASED",
        );
        displayMessage(
...
var project20 = {
    ...
    effect: function () {
        project20.flag = 1;
        displayMessage(
            "Run tournament, pick strategy, earn Yomi equal to that strategy's points.",
        );
        standardOps = standardOps - 12000;
...
var project27 = {
    ...
    effect: function () {
        project27.flag = 1;
        displayMessage(
            "Coherent Extrapolated Volition complete, TRUST INCREASED",
        );
        yomi = yomi - 1000;
...
var project133 = {
    ...
    priceTag:
        ...
        " creat, " +
        (threnodyCost / 10).toLocaleString() +
        " yomi)",
