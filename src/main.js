...
function quantumCompute() {
    ...
    for (var i = 0; i < qChips.length; i++) {
        qChips[i].value = Math.sin(
            qClock * qChips[i].waveSeed * qChips[i].active,
        );
...
function qComp() {
    ...
    if (qChips[0].active == 0) {
        document.getElementById("qCompDisplay").innerHTML =
            "Need Photonic Chips";
    } else {
        for (var i = 0; i < qChips.length; i++) {
            q = q + qChips[i].value;
        ...
        document.getElementById("qCompDisplay").innerHTML =
            "qOps: " + Math.ceil(q * 360).toLocaleString();
    }
}
...
function longBlink(elemID) {
    ...
    function longToggleVisibility(elemID) {
        ...
        if (longBlinkCounter > 30 && longBlinkCounter < 40) {
            document.getElementById("hypnoDroneText").innerHTML =
                "<br /><br /><br />Release";
        }
        ...
        if (longBlinkCounter > 55) {
            document.getElementById("hypnoDroneText").innerHTML =
                "Release<br/>the<br/>Hypno<br/>Drones";
        }
...
function buttonUpdate() {
    ...
    if (probesLostHaz < 1) {
        ...
        document.getElementById("probesLostHazardsDisplay").innerHTML =
            numberCruncher(probesLostHaz);
    }
...
function investUpgrade() {
    ...
    document.getElementById("investUpgradeCost").innerHTML =
        investUpgradeCost.toLocaleString();
...
function updateStocks() {
    for (var i = 0; i < portfolioSize; i++) {
        ...
        if (Math.random() < 0.6) {
            ...
            var delta = Math.ceil(
                (Math.random() * currentPrice) / (4 * riskiness),
            );
...
function updateUpgrades() {
    ...
    document.getElementById("nextFactoryUpgrade").innerHTML =
        nfup.toLocaleString();
    document.getElementById("nextDroneUpgrade").innerHTML =
        ndup.toLocaleString();
}
...
function updateSwarm() {
    ...
    if (swarmStatus == 0) {
        ...
        document.getElementById("giftCountdown").innerHTML =
    ...
    if (swarmStatus == 3) {
        document.getElementById("swarmEntertainCost").innerHTML =
            entertainCost.toLocaleString();
...
function updatePower() {
    if (spaceFlag == 0) {
        ...
        document.getElementById("powerProductionRate").innerHTML = Math.round(
            supply * 100,
        ).toLocaleString();
        document.getElementById("powerConsumptionRate").innerHTML = Math.round(
            demand * 100,
        ).toLocaleString();
        document.getElementById("storedPower").innerHTML =
            Math.round(storedPower).toLocaleString();
        document.getElementById("facPowConRate").innerHTML = Math.round(
            fDemand * 100,
        ).toLocaleString();
        document.getElementById("dronePowConRate").innerHTML = Math.round(
            dDemand * 100,
        ).toLocaleString();
...
function buyAds() {
    if (funds >= adCost) {
        ...
        document.getElementById("adCost").innerHTML = adCost.toLocaleString(
            undefined,
            { minimumFractionDigits: 2, maximumFractionDigits: 2 },
        );
        document.getElementById("funds").innerHTML = funds.toLocaleString(
...
function updateStats() {
    ...
    document.getElementById("operations").innerHTML =
        Math.floor(operations).toLocaleString();
    document.getElementById("trust").innerHTML =
        Math.floor(trust).toLocaleString();
    document.getElementById("nextTrust").innerHTML =
        Math.floor(nextTrust).toLocaleString();
    if (creativityOn) {
        document.getElementById("creativity").innerHTML =
            Math.round(creativity).toLocaleString();
    }

    document.getElementById("factoryLevelDisplaySpace").innerHTML =
        numberCruncher(Math.floor(factoryLevel));
...
function calculateRev() {
    ...
    document.getElementById("avgSales").innerHTML =
...
function increaseProbeTrust() {
    ...
    document.getElementById("probeTrustCostDisplay").innerHTML =
        Math.floor(probeTrustCost).toLocaleString();
...
function increaseMaxTrust() {
    ...
    document.getElementById("maxTrustDisplay").innerHTML =
        maxTrust.toLocaleString();
...
function makeProbe() {
    ...
    document.getElementById("probesLaunchedDisplay").innerHTML =
        numberCruncher(probeLaunchLevel);
...
function spawnProbes() {
    ...
    document.getElementById("probesTotalDisplay").innerHTML =
        numberCruncher(probeCount);
}

function exploreUniverse() {
    document.getElementById("availableMatterDisplay").innerHTML =
    ...
    document.getElementById("availableMatterDisplay").innerHTML =
        numberCruncher(availableMatter);
    document.getElementById("colonizedDisplay").innerHTML = (
        100 /
...
function drift() {
    ...
    document.getElementById("probesLostDriftDisplay").innerHTML =
        numberCruncher(probesLostDrift);
    document.getElementById("probesTotalDisplay").innerHTML =
        numberCruncher(probeCount);
...
window.setInterval(function () {
    ...
    if (humanFlag == 1) {
        ...
        demand =
            (0.8 / margin) * marketing * marketingEffectiveness * demandBoost;
    ...
    if (dismantle >= 5) {
        ...
        for (var i = 0; i < qChips.length; i++) {
            qChips[i].value = 0.5;
            document.getElementById("qChip" + i).style.opacity =
                qChips[i].value;
        }
...
function load() {
    ...
    var loadProjectsFlags = JSON.parse(
        localStorage.getItem("saveProjectsFlags"),
    );
...
function load1() {
    ...
    var loadProjectsUses = JSON.parse(
        localStorage.getItem("saveProjectsUses1"),
    );
    var loadProjectsFlags = JSON.parse(
    ...
    var loadStratsActive = JSON.parse(
        localStorage.getItem("saveStratsActive1"),
    );
...
function load2() {
    ...
    var loadProjectsUses = JSON.parse(
        localStorage.getItem("saveProjectsUses2"),
    );
    var loadProjectsFlags = JSON.parse(
    ...
    var loadStratsActive = JSON.parse(
        localStorage.getItem("saveStratsActive2"),
    );
